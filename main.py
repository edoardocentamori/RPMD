...
# Main is used to run the entire model and sketch some basic graph used mainly for debugging purposes,
# output data are saved as byte files and processed elsewhere
...
Q_n, V_n = verlet_algorithmM(q_0, v_0, beta, fix=fix, fixc=fixc, fixcm=fixcm, lenf=lenf, lenfc=lenfc, norm=1, therm=True, debug=False, H2=True)  # debug: removed linear=linear, fixL=fixL

end = time.time()
print(end - start)

# Here are defined several observables of the system
