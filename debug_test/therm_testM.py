...
Q_n0 = Q_n[:, :, 0, :]
V_n0 = V_n[:, :, 0, :]
Q_n = Q_n0.reshape(steps, N, 1, dim)
...
ax1.set_title('Single energy distribution')
ax1.set_xlabel('Energy [a.u.]')
ax1.set_ylabel('Probability density [a.u]')
...
ax2.set_xlabel('mode')
ax2.set_ylabel('fitted $\\beta_N$')
ax2.set_title('Fitted $\\beta_N$')
