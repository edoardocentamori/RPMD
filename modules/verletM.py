...
def verlet_step2M(q,v,dV0int,dV0ext,beta,fix=None,pos=None,fixc=None,posc=None,lenf=None,lenfc=None, therm= None):
    """
    ...
    lamda_r = constrained_r(q,vt,(dV0ext+dV0int)/M,fix,pos,fixc,posc,lenf,lenfc)
    # evaluate v(n+1/2)    
    ...
    # evaluate lamda_v(n+1)
    lamda_vp = constrained_v(q1,vp,(dV1ext+dV1int)/M,fix,pos,fixc,posc,lenf,lenfc)
    # evaluate v(n+1)
...
def verlet_algorithmM(q_0,v_0,beta,fix=None,pos=None,fixc=None,posc=None,lenf=None,lenfc=None,norm=0,therm=None,debug=False):
    Q_n, V_n= [], []
    q_n, v_n = q_0, v_0
    ...
    for _ in range(steps):
        ...
        if norm==0:
            ...
            q_n, v_n, dV0int,dV0ext = verlet_step2M(q_n, v_n,dV0int,dV0ext,beta,fix=fix,pos=pos,fixc=fixc,posc=posc,lenf=lenf,lenfc=lenfc,therm=therm)
