...
def verlet_step1(q,v,dV0,fix=None,pos=None,fixc=None,posc=None,lenf=None,lenfc=None):
    """
    ...
    lamda_r = constrained_r(q,v,dV0,fix,pos,fixc,posc,lenf,lenfc)
    # evaluate v(n+1/2)
    vp = v-dVext(q)*dt/2-dt/2*lamda_r #MUST DO: bring dVext0 from previous step
